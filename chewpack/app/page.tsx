        ...
        <div className='mx-auto flex min-h-screen max-w-7xl flex-col px-6 py-10'>
          <header className='flex items-center justify-between'>
            ...
            <Link
              ...
              className='rounded-lg border border-white/15 px-5 py-3 text-sm font-medium text-white transition hover:bg-white hover:text-black'
            >
          ...
          <section className='grid flex-1 items-center gap-12 py-16 md:grid-cols-[1.1fr_0.9fr]'>
            <div>
              <p className='inline-flex rounded-lg border border-white/10 bg-white/5 px-4 py-2 text-sm text-white/70'>
                Choose your license
              </p>
              <h2 className='mt-6 max-w-lg text-5xl font-semibold leading-tight tracking-tight md:text-7xl'>
                Make your own font.
            ...
            <div className='mt-8 flex flex-col gap-4 sm:flex-row'>
              <Link
                href='/checkout?plan=1y'
                className='rounded-lg bg-white px-7 py-4 text-center text-sm font-semibold text-black transition hover:bg-white/85'
              >
                  Continue to secure checkout
                </Link>
                <a
                  href='#features'
                  className='rounded-lg border border-white/15 px-7 py-4 text-center text-sm font-semibold text-white transition hover:bg-white/10'
                >
                  See features
                </a>
              </div>
            ...
            <div className='relative'>
              <div className='absolute -inset-8 rounded-[3rem] bg-white/10 blur-lg' />
              <div className='relative overflow-hidden rounded-[2rem] border border-white/10 bg-[#0b1020] shadow-lg'>
                <div className='flex items-center gap-2 border-b border-white/10 px-5 py-4'>
                  <span className='h-3 w-3 rounded-lg bg-white/25' />
                  <span className='h-3 w-3 rounded-lg bg-white/15' />
                  <span className='h-3 w-3 rounded-lg bg-white/10' />
                ...
                <div className='grid min-h-[440px] grid-cols-[90px_1fr]'>
                  ...
                  <div className='relative p-8'>
                    <div className='mb-6 flex items-center justify-between'>
                      ...
                      <div className='rounded-lg bg-white/10 px-4 py-2 text-xs text-white/60'>
                        Smooth preview
                      </div>
                    </div>
                    <div className='relative flex h-[300px] items-center justify-center rounded-lg border border-white/10 bg-[#080c18]'>
                      ...
                      <div className='absolute left-[54%] top-[38%] h-4 w-4 rounded-lg border-2 border-white bg-[#050814]' />
                      <div className='absolute left-[61%] top-[32%] h-3 w-3 rounded-lg bg-white' />
